...
namespace Soenneker.X.OpenApiClient.Models
{
    ...
    public partial class OperationalDisconnectProblem : global::Soenneker.X.OpenApiClient.Models.Problem, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.X.OpenApiClient.Models.OperationalDisconnectProblem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::Soenneker.X.OpenApiClient.Models.OperationalDisconnectProblem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.X.OpenApiClient.Models.OperationalDisconnectProblem();
        }
        /// <summary>

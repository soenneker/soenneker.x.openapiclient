...
namespace Soenneker.X.OpenApiClient.Two.Tweets.Counts.All
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.AllRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.AllRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.AllRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
            ...
            /// <summary>The granularity for the search counts results.</summary>
            [QueryParameter("granularity")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.GetGranularityQueryParameterType? GranularityAsGetGranularityQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("search_count%2Efields")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.GetSearch_countFieldsQueryParameterType[]? SearchCountFieldsAsGetSearchCountFieldsQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("search_count%2Efields")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.GetSearch_countFieldsQueryParameterType[] SearchCountFieldsAsGetSearchCountFieldsQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AllRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Tweets.Counts.All.AllRequestBuilder.AllRequestBuilderGetQueryParameters>
        {
        }
    }
}

...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetExcludeQueryParameterType[]? Exclude { get; set; }
#nullable restore
#else
            [QueryParameter("exclude")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetExcludeQueryParameterType[] Exclude { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetExpansionsQueryParameterType[]? Expansions { get; set; }
#nullable restore
#else
            [QueryParameter("expansions")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetExpansionsQueryParameterType[] Expansions { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetMediaFieldsQueryParameterType[]? MediaFields { get; set; }
#nullable restore
#else
            [QueryParameter("media%2Efields")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetMediaFieldsQueryParameterType[] MediaFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetPlaceFieldsQueryParameterType[]? PlaceFields { get; set; }
#nullable restore
#else
            [QueryParameter("place%2Efields")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetPlaceFieldsQueryParameterType[] PlaceFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetPollFieldsQueryParameterType[]? PollFields { get; set; }
#nullable restore
#else
            [QueryParameter("poll%2Efields")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetPollFieldsQueryParameterType[] PollFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetTweetFieldsQueryParameterType[]? TweetFields { get; set; }
#nullable restore
#else
            [QueryParameter("tweet%2Efields")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetTweetFieldsQueryParameterType[] TweetFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetUserFieldsQueryParameterType[]? UserFields { get; set; }
#nullable restore
#else
            [QueryParameter("user%2Efields")]
            public global::Soenneker.X.OpenApiClient.Two.Tweets.Item.Quote_tweets.GetUserFieldsQueryParameterType[] UserFields { get; set; }

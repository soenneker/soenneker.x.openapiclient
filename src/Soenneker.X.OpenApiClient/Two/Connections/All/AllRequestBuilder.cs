...
#nullable enable
        public async Task<global::Soenneker.X.OpenApiClient.Models.DeleteAllConnectionsResponse?> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.X.OpenApiClient.Models.DeleteAllConnectionsResponse> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.X.OpenApiClient.Models.DeleteAllConnectionsResponse>(requestInfo, global::Soenneker.X.OpenApiClient.Models.DeleteAllConnectionsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Terminates all active streaming connections for the authenticated application.
        /// </summary>

...
namespace Soenneker.X.OpenApiClient.Two.Connections
{
    ...
    public partial class ConnectionsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsResponse?> DeleteAsync(global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsResponse> DeleteAsync(global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsResponse>(requestInfo, global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns active and historical streaming connections with disconnect reasons for the authenticated application.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.X.OpenApiClient.Models.GetConnectionHistoryResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.X.OpenApiClient.Models.Error">When receiving a 4XX or 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.X.OpenApiClient.Models.GetConnectionHistoryResponse?> GetAsync(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Connections.ConnectionsRequestBuilder.ConnectionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.X.OpenApiClient.Models.GetConnectionHistoryResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Connections.ConnectionsRequestBuilder.ConnectionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.X.OpenApiClient.Models.GetConnectionHistoryResponse>(requestInfo, global::Soenneker.X.OpenApiClient.Models.GetConnectionHistoryResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Terminates multiple streaming connections by their UUIDs for the authenticated application.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(global::Soenneker.X.OpenApiClient.Models.DeleteConnectionsByUuidsRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)

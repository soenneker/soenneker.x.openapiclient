...
#nullable restore
        ...
        public async Task<global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Tweets.Firehose.StreamNamespace.Lang.En.EnRequestBuilder.EnRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnResponse>(requestInfo, global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Streams all public English-language Posts in real-time.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnExpansionsParameterItem[]? Expansions { get; set; }
#nullable restore
#else
            [QueryParameter("expansions")]
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnExpansionsParameterItem[] Expansions { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnMediaFieldsParameterItem[]? MediaFields { get; set; }
#nullable restore
#else
            [QueryParameter("media%2Efields")]
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnMediaFieldsParameterItem[] MediaFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnPlaceFieldsParameterItem[]? PlaceFields { get; set; }
#nullable restore
#else
            [QueryParameter("place%2Efields")]
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnPlaceFieldsParameterItem[] PlaceFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnPollFieldsParameterItem[]? PollFields { get; set; }
#nullable restore
#else
            [QueryParameter("poll%2Efields")]
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnPollFieldsParameterItem[] PollFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnTweetFieldsParameterItem[]? TweetFields { get; set; }
#nullable restore
#else
            [QueryParameter("tweet%2Efields")]
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnTweetFieldsParameterItem[] TweetFields { get; set; }
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnUserFieldsParameterItem[]? UserFields { get; set; }
#nullable restore
#else
            [QueryParameter("user%2Efields")]
            public global::Soenneker.X.OpenApiClient.Models.StreamPostsFirehoseEnUserFieldsParameterItem[] UserFields { get; set; }

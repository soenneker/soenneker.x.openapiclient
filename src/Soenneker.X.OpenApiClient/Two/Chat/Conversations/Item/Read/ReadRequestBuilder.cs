...
namespace Soenneker.X.OpenApiClient.Two.Chat.Conversations.Item.Read
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.X.OpenApiClient.Two.Chat.Conversations.Item.Read.ReadRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.X.OpenApiClient.Two.Chat.Conversations.Item.Read.ReadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.X.OpenApiClient.Two.Chat.Conversations.Item.Read.ReadRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.X.OpenApiClient.Two.Chat.Conversations.Item.Read.ReadRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

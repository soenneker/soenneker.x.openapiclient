...
namespace Soenneker.X.OpenApiClient.Two.Dm_conversations.With.Item.Dm_events
{
    ...
    public partial class Dm_eventsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Dm_eventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/dm_conversations/with/{participantId}/dm_events{?dm_event%2Efields,event_types,expansions,max_results*,media%2Efields,pagination_token*,post%2Efields,user%2Efields}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.X.OpenApiClient.Two.Dm_conversations.With.Item.Dm_events.Dm_eventsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Dm_eventsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/2/dm_conversations/with/{participantId}/dm_events{?dm_event%2Efields,event_types,expansions,max_results*,media%2Efields,pagination_token*,post%2Efields,user%2Efields}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<global::Soenneker.X.OpenApiClient.Models.GetDirectMessagesEventsByParticipantIdResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Dm_conversations.With.Item.Dm_events.Dm_eventsRequestBuilder.Dm_eventsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.X.OpenApiClient.Models.GetDirectMessagesEventsByParticipantIdResponse>(requestInfo, global::Soenneker.X.OpenApiClient.Models.GetDirectMessagesEventsByParticipantIdResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get Direct Messages Events by Participant ID
        /// </summary>

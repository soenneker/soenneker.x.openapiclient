...
#nullable restore
        ...
        public async Task<global::Soenneker.X.OpenApiClient.Models.GetUsersPostsResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Users.Item.Tweets.TweetsRequestBuilder.TweetsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.X.OpenApiClient.Models.GetUsersPostsResponse>(requestInfo, global::Soenneker.X.OpenApiClient.Models.GetUsersPostsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// When both are provided, `start_time` must be earlier than `end_time`. When both are provided, `since_id` must be less than `until_id`.
        /// </summary>

...
#nullable restore
        ...
        public async Task<global::Soenneker.X.OpenApiClient.Models.GetUsersTimelineResponse> GetAsync(Action<RequestConfiguration<global::Soenneker.X.OpenApiClient.Two.Users.Item.Timelines.Reverse_chronological.Reverse_chronologicalRequestBuilder.Reverse_chronologicalRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.X.OpenApiClient.Models.GetUsersTimelineResponse>(requestInfo, global::Soenneker.X.OpenApiClient.Models.GetUsersTimelineResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// When both are provided, `start_time` must be earlier than `end_time`. When both are provided, `since_id` must be less than `until_id`.
        /// </summary>
...
#nullable enable
            ...
            public global::Soenneker.X.OpenApiClient.Models.GetUsersTimelineExcludeParameterItem[]? Exclude { get; set; }

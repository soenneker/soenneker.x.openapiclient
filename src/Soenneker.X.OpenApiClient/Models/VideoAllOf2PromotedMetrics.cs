...
namespace Soenneker.X.OpenApiClient.Models
{
    ...
    public partial class VideoAllOf2PromotedMetrics : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.X.OpenApiClient.Models.VideoAllOf2PromotedMetrics"/> and sets the default values.
        /// </summary>
        public VideoAllOf2PromotedMetrics()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.X.OpenApiClient.Models.VideoAllOf2PromotedMetrics"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.X.OpenApiClient.Models.VideoAllOf2PromotedMetrics CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.X.OpenApiClient.Models.VideoAllOf2PromotedMetrics();
        }
        /// <summary>

...
namespace Soenneker.X.OpenApiClient.Models
{
    ...
    public partial class PostGeoCoordinates : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.X.OpenApiClient.Models.PostGeoCoordinates"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.X.OpenApiClient.Models.PostGeoCoordinates CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.X.OpenApiClient.Models.PostGeoCoordinates();
        }
        /// <summary>
